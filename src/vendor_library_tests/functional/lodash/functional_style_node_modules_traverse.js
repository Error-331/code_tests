...
const {stubTrue, eq, cond, constant, complement, curry, map, concat, filter, contains} = require('lodash/fp');
...
const traverseDirectory = curry((mapFunc, filterFunc,  rootDirPath) => {
...
const traverseDirectoryRecursive = curry((userCallback, filterFunc, pathTransformFunc, dirPath) => {
    ...
    return cond([
        ...
        [stubTrue, () => traverseDirectory(mapCallback, filterFunc, transformedPath)]
    ])(preparedDirPath);
});
