...
const {determineMaxVersion} = require('./helpers/semver_helpers');
...
const b = generateSync(function* () {
    ...
    console.log(determineMaxVersion(b));
       ...
       // .then(() => {
        //    getDBEffects(dbType)
         //       .importFromJSON(dbConnection,`${__dirname}/../../../../test.json`).then(() => {
                ...
                //console.log(determineMaxVersion('  1.2.3 - 2.3.4 ||   >=3.5.6  || 2.5.6 -   2.6.0 || >=   1.2.3 <   2.4.0 '));
