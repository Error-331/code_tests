...
/**
 * Checks whether provided value belongs to exceptions list.
 *
 */
...
/**
 * Checks whether directory belongs to exceptions list.
 *
 */
...
const pathToRootNodeModules = '/home/segei/projects/code_tests/node_modules';
const b1 = pipe(combinePaths('/home/segei/projects/code_tests/node_modules'), justNullBy(isEntityReadable), (a) => {console.log(a); return a;});
